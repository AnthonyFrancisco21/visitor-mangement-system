...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const data: { success?: boolean; role?: string; error?: string } =
        await res.json();
      ...
      <aside className={styles.leftPanel} aria-hidden="true">
        ...
        <div className={styles.leftCenter}>
          ...
          <p className={styles.taglineDesc}>
            Manage visitor registrations, RFID check-ins, and real-time building
            access — all from one unified dashboard.
          </p>
        </div>
      ...
      <section className={styles.rightPanel}>
        <div className={styles.formWrapper}>
          ...
          <div
            ...
            aria-label="Access level descriptions"
          >
